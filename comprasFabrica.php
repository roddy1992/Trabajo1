                ...
                <div class="container">
                    ...
                    <form class="well form-horizontal"  id="contact_form">
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 inputGroupContainer">
                                    <div class="input-group">
                                        ...
                                        <input  name="codigoVenFa" id="codigoVenFa" placeholder="Vendedor Ejemplo:  V100" class="form-control" maxlength="4" type="text" onkeyup="javascript:this.value = this.value.toUpperCase();">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label">Numero de Productos</label>  
                                <div class="col-md-4 inputGroupContainer">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                        <input  name="numeroProFa" id="numeroProFa" placeholder="Cantidad de Producto" class="form-control"  type="text" maxlength="9" onchange="tipovendedor();">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 inputGroupContainer">
                                    <div class="input-group">
                                        ...
                                        <input name="categoriaVenFa"  id="categoriaVenFa" placeholder="Categoria del Vendedor " class="form-control"  type="text" readonly>
                                    </div>
                                </div>
                            </div>                            
                            <!-- Success message -->
                            <div class="alert alert-success" role="alert" id="success_message_CompraFa" style="display:none">Success <i class="glyphicon glyphicon-thumbs-up"></i> Thanks for contacting us, we will get back to you shortly.</div>

                            <!-- Button -->
                            <div class="form-group">
                                <label class="col-md-4 control-label"></label>
                                <div class="col-md-4">
                                    <button  class="btn btn-success enviarcompraFa">Guardar <span class="glyphicon glyphicon-saved"></span></button>
                                </div>
                            </div>
                        </fieldset>
                    </form>
