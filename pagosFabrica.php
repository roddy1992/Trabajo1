            ...
            <div class="container">
                <div class="row">
                    ...
                    <section>
                        <div class="container">
                            <div id="dvData2">
                                <center><h2>Realizar pago a Vendedores</h2></center>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4 inputGroupContainer">
                                            <div class="input-group">
                                                ...
                                                <input  name="codVenbusqueda" id="codVenbusqueda" placeholder="Codigo del Vendedor  Ejemplo: V100" class="form-control"  type="text" maxlength="4" onkeyup="javascript:this.value=this.value.toUpperCase();" >
                                            </div>
                                        </div>
                                    </div>
                                    <td><button id="consultapagoVendedorFa" class="btn btn-info consultapagoVendedorFa">Consultar <span class="glyphicon glyphicon-search"></span></button></td>
                                    </tr>
                                </table>
                                ...
                                <table class="table table-striped table-bordered">                       
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Fabrica donde Solicito Pago</th>
                                            <th>Fecha de Solicitud</th> 
                                            <th>Valor a Pagar</th> 
                                        </tr>
                                    </thead>
                                    <tbody id="tablapagoFab">
...
<script type="text/javascript">
                                $("#fechainicioreportesemanalFab").datepicker();
                                $("#fechafinreportesemanalFab").datepicker();
</script>
</body>
</html>