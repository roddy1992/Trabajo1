            ...
            <section id="content">
                <div class="container">
                    <div class="row">
                        ...
                        <section>
                            <div class="container ">
                                <center><h2>Solicitud de Pago</h2></center>
                                <div class="row">
                                    <div class="col-lg-offset-2">
                                        <table class="table-hover">
                                            <tr>                    
                                                <td class="col-lg-8">Listado de Fabricas Aliadas<select class="form-control show-menu-arrow" id="fabricasaliadas" name="fabricasaliadas"  data-style="btn-info"></td> 
                                                <td><table class="table table-responsive">
                                                        <tr>
                                                            <td class="col-lg-3"><button id="boton" class="btn btn-success solicituddepago" >Solicitar <span><i class="glyphicon glyphicon-send"></i></span></button></td>
                                                            <td class="col-lg-3" style="font-style: oblique;font-size:30px;text-align: right;">$</td>
                                                            <td>
                                                                <input type="text"  class="form-control" id="valoracobrarVendedor" style="font-style: oblique;font-size:30px;text-align: left;width: 100px;height: 50px" readonly>
                                                            </td>
                                                        </tr>
                                                    </table> </td>
                                            </tr>
        ...
        <div class="container">
            ...
            <form class="well form-horizontal"  id="contact_form_Fab">
                <fieldset>
                    ...
                    <!-- Form Name -->
                    <legend>Informacion de la Fabrica                           
                    </legend>                           

                    <!-- Text input-->

                    <div class="form-group">
                        <label class="col-md-4 control-label">Codigo de la Fabrica</label>  
                        <div class="col-md-4 inputGroupContainer">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-tag"></i></span>
                                <input  name="codigoFabricaVen" id="codigoFabricaVen" placeholder="Codigo de Fabrica" class="form-control"  type="text" readonly>
                            </div>
                        </div>
                    </div>    
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4 inputGroupContainer">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                <input  name="nombreRepresentanteFaVen" id="nombreRepresentanteFaVen" placeholder="Representante" class="form-control"  type="text" readonly>
                            </div>
                        </div>
                    </div>                            
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4 inputGroupContainer">
                            <div class="input-group">
                                <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                <input  name="nombreFabricaVen" id="nombreFabricaVen" placeholder="Nombre de la Fabrica" class="form-control"  type="text" readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4 inputGroupContainer">
                            <div class="input-group">
                                ...
                                <input name="direccionFabricaVen" id="direccionFabricaVen" placeholder="Direcion de la Fabrica " class="form-control"  type="text" readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4 inputGroupContainer">
                            <div class="input-group">
                                ...
                                <input name="cedularFabricaVen" id="cedularFabricaVen" placeholder="0999999999" class="form-control" type="text"  readonly maxlength="10">                                        
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4 inputGroupContainer">
                            <div class="input-group">
                                ...
                                <input name="convencionalFabricaVen" id="convencionalFabricaVen" placeholder="(02)2222222" class="form-control" type="text" readonly>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4 inputGroupContainer">
                            <div class="input-group">
                                ...
                                <input name="whatsappFabricaVen" id="whatsappFabricaVen" placeholder="0999999999" class="form-control" type="text" readonly maxlength="10">                                       
                            </div>
                        </div>
                    </div>
