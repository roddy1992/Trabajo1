                ...
                <div class="container">
                    ...
                    <form class="well form-horizontal"  id="contact_form_Fab">
                        <fieldset>
                            ...
                            <!-- Form Name -->
                            <legend>Asignacion de Usauarios                           
                            </legend>

                            <!-- Text input-->

                            <div class="form-group">
                                <label class="col-md-4 control-label">Codigo del Vendedor</label>  
                                <div class="col-md-4 inputGroupContainer">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                        <select class="form-control show-menu-arrow vendedoressinUsuario" id="vendedoressinUsuario" name="vendedoressinUsuario"  data-style="btn-info"></select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 inputGroupContainer">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                        <input  name="nombrevendedorsinUsuario" id="nombrevendedorsinUsuario" placeholder="Nombre" class="form-control"  type="text" required readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                <label class="col-md-4 control-label">CI del Vendedor</label>  
                                <div class="col-md-4 inputGroupContainer">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-credit-card"></i></span>
                                        <input  name="civendedorsinUsuario" id="civendedorsinUsuario" placeholder="CI" class="form-control"  type="text" required readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 inputGroupContainer">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                        <input name="usuariovendedorsinUsuario" id="usuariovendedorsinUsuario" placeholder="Usuario del Vendedor" class="form-control" type="text">                                        
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 inputGroupContainer">
                                    <div class="input-group">
                                        ...
                                        <input name="clavevendedorsinUsuario" id="clavevendedorsinUsuario" placeholder="Clave del Vendedor" class="form-control" type="password">                                          
                                    </div>
                                    <a href="http://www.clavesegura.org/" target="_blank" class="btn btn-block">Generador de Claves</a>  
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 inputGroupContainer">
                                    <div class="input-group">
                                        ...
                                        <input name="tipovendedorsinUsuario" id="tipovendedorsinUsuario" value="V" class="form-control" type="text" readonly>                                        
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 inputGroupContainer">
                                    <div class="input-group">
                                        ...
                                        <input name="correovendedorsinUsuario"  id="correovendedorsinUsuario" placeholder="Correo donde enviar Credenciales" class="form-control"  type="email">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <button  class="btn btn-success enviarvendedorsinUsuario">Guardar <span class="glyphicon glyphicon-saved"></span></button>
                                    <button type='button'  class="btn btn-info verUsuarios" data-toggle='modal' data-target='#ModalUsuario' >Ver Lista de Usuarios <span class="glyphicon glyphicon-eye-open"></span></button>
                                </div>
                            </div>
                                    ...
                                    <div class="modal-dialog">
                                        ...
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title">Resetear Claves de los Usuarios</h4>
                                            </div>
                                            <div class="modal-body" style="background:rgb(227, 227, 227)">
                                                <table class="table table-bordered table-striped">                                            
                                                    ...
                                                    <tbody id="tablaconusuarioaResetear">
