                ...
                <div class="row">
                    ...
                    <section>
                        <div class="container">
                            ...
                            <div >
                                <center><h2>Especifico Fabricante</h2></center>
                                <table class="table-bordered">
                                    <tr>
                                    <div class="form-group">
                                        <label class="col-md-4 control-label">Codigo Fabrica</label>  
                                        <div class="col-md-4 inputGroupContainer">
                                            <div class="input-group">
                                                <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
                                                <input  name="codFabbusqueda" id="codFabbusqueda" placeholder="Codigo de la Fabrica" class="form-control"  type="text" maxlength="4" onkeyup="javascript:this.value = this.value.toUpperCase();">
                                            </div>
                                        </div>
                                    </div>
                                    </tr>
                                    <tr>
                                        <td> Fecha de Inicio <input type="text" id="fechainicioventasFab" class="form-control"></td>
                                        <td> Fecha de Fin <input type="text" id="fechafinventasFab" class="form-control"></td>
                                        <td><button id="consultareporteventasfabricasAdm" class="btn btn-info consultareporteventasfabricasAdm">Consultar <span class="glyphicon glyphicon-search"></span></button></td>
                                    </tr>
                                </table>
                                <br>
                                <div class="panel-body" style="width:100%; height:400px; overflow:auto;">
                                    <table class="table table-striped table-bordered">                       
                                        ...
                                        <tbody id="tablaconsultaventasfabricaAd">
...
<script type="text/javascript">
                                                    $("#fechainicioventasFab").datepicker();
                                                    $("#fechafinventasFab").datepicker();
</script>
