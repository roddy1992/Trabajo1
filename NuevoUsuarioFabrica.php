                        ...
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 inputGroupContainer">
                                    <div class="input-group">
                                        ...
                                        <select class="form-control show-menu-arrow fabricassinUsuario" id="fabricassinUsuario" name="fabricassinUsuario"  data-style="btn-info"></select>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 inputGroupContainer">
                                    <div class="input-group">
                                        ...
                                        <input  name="nombrerepreFabsinUsuario" id="nombrerepreFabsinUsuario" placeholder="Nombre" class="form-control"  type="text" required readonly>
                                    </div>
                                </div>
                            </div>

                            <div class="form-group">
                                <label class="col-md-4 control-label">CI del Representante</label>  
                                <div class="col-md-4 inputGroupContainer">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-credit-card"></i></span>
                                        <input  name="cirepreFabsinUsuario" id="cirepreFabsinUsuario" placeholder="CI" class="form-control"  type="text" required readonly>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 inputGroupContainer">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                                        <input name="usuarioFabsinUsuario" id="usuarioFabsinUsuario" placeholder="Usuario de la Fabrica" class="form-control" type="text">                                        
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 inputGroupContainer">
                                    <div class="input-group">
                                        ...
                                        <input name="claveFabsinUsuario" id="claveFabsinUsuario" placeholder="Clave de la Fabrica" class="form-control" type="password">                                          
                                    </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 inputGroupContainer">
                                    <div class="input-group">
                                        ...
                                        <input name="tipoFabsinUsuario" id="tipoFabsinUsuario" value="F" class="form-control" type="text" readonly>                                        
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4 inputGroupContainer">
                                    <div class="input-group">
                                        ...
                                        <input name="correoFabsinUsuario"  id="correoFabsinUsuario" placeholder="Correo donde enviar Credenciales" class="form-control"  type="email">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <button  class="btn btn-success enviarFabsinUsuario">Guardar <span class="glyphicon glyphicon-saved"></span></button>
                                </div>
                            </div>
