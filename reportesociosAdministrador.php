        ...
        <section id="content">
            <div class="container">
                <div class="row">
                    ...
                    <div class="container">
                        <div >
                            <center><h2>Informe de Socios</h2></center>
                            <div class="col-lg-6">
                                <table class="table table-responsive">
                                    <tr>
                                        <td>
                                            <button id="vendedoreslistaAd" class="btn btn-info">Todos <span class="glyphicon glyphicon-user"></span></button>
                                            <button id="vendedoresactivosAd" class="btn btn-warning">Activos <span class="glyphicon glyphicon-filter"></span></button>
                                            <button id="vendedoresinactivosAd" class="btn btn-danger">Inactivos <span class="glyphicon glyphicon-filter"></span></button>
                                        </td>
                                    </tr>
                                </table>
                                <table class="table table-striped table-bordered">  
                                    <caption><h3>Vendedores</h3></caption>
                                    <thead>
                                        <tr>
                                            <th>Codigo Vendedor</th>
                                            <th>Fabrica de Incripcion</th>                                           
                                        </tr>
                                    </thead>
                                    <tbody id="tablavendedoresdesdeAdm">
                            ...
                            <div class="col-lg-6">
                                <table class="table table-responsive">
                                    <tr>
                                        <td>                                            
                                            <button id="fabricasactivosAd" class="btn btn-warning">Activos <span class="glyphicon glyphicon-filter"></span></button>
                                            <button id="fabricasinactivosAd" class="btn btn-danger">Inactivos <span class="glyphicon glyphicon-filter"></span></button>
                                        </td>
                                    </tr>
                                </table>
                                <table class="table table-striped table-bordered">  
                                    <caption><h3>Fabricas</h3></caption>
                                    <thead>
                                        <tr>
                                    ...
                                    <tbody id="tablafabricasdesdeAdm">
