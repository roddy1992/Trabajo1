                    ...
                    <form class="well form-horizontal"  id="contact_form">
                        <fieldset>
                            ...
                            <div class="form-group">
                             ...
                             <!-- Text input-->
                            <div class="form-group">
                                <label class="col-md-4 control-label">Fabrica Ligada</label>  
                                <div class="col-md-4 inputGroupContainer">
                                    <div class="input-group">
                                        <span class="input-group-addon"><i class="glyphicon glyphicon-home"></i></span>
                                        <input name="fabricaligadaVen"  id="fabricaligadaVen" placeholder=" A que Fabrica esta Ligado? " class="form-control"  type="text" maxlength="4" onkeyup="javascript:this.value=this.value.toUpperCase();">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <button  class="btn btn-success enviarVen">Guardar <span class="glyphicon glyphicon-saved"></span></button>
                                </div>
                            </div>
