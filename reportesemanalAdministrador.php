                    ...
                    <section>
                        <div class="container">
                            <div class="panel-body" style="width:100%; height:400px; overflow:auto;">
                                <div id="VentasSemanalesAd">
                                    <center><h2>Informe de  ventas Semanales</h2></center>
                                    <table class="table-bordered">
                                        <tr>
                                            <td> Fecha de Inicio <input type="text" id="fechainicioAdmin" class="form-control"></td>
                                            <td> Fecha de Fin <input type="text" id="fechafinAdmin" class="form-control"></td>
                                            <td><button id="consultareportesemanalAdm" class="btn btn-info consultareportesemanalAdm">Consultar <span class="glyphicon glyphicon-search"></span></button></td>
                                        </tr>
                                    </table>
                                    ...
                                    <table class="table table-striped table-bordered" >                       
                                        ...
                                        <tbody id="tablasemanalAdministrador" >
                            ...
                            <script>
                                $("#btnExport").click(function (e) {
                                    window.open('data:application/vnd.ms-excel,' + encodeURIComponent($('#VentasSemanalesAd').html()));
                                    e.preventDefault();
                                });
                            </script>
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <table class="table table-striped table-bordered" >
                            ...
                            <tbody id="tablagananciasemanandvendedorAdm" >
                            </tbody>
                        </table>
                    </div>
                    <div class="col-lg-3">
                        <table class="table table-striped table-bordered" > 
                            ...
                            <tbody id="tablagananciasemanandfabricaAdm" >
                            </tbody>
                        </table>
                    </div>
                    <div class="col-lg-6">
                        <div class="panel-body" style="width:100%; height:300px; overflow:auto;">
                            ...
                            <tbody id="tablagananciasemanalempresaAdm" >
                            </tbody>
                        </table>
                        </div>                        
                    </div>
...
<script type="text/javascript">
                                $("#fechainicioAdmin").datepicker();
                                $("#fechafinAdmin").datepicker();
</script>
