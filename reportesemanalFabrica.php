                        ...
                        <div class="container">
                            <div id="dvData1">
                                ...
                                <table class="table-bordered">
                                    <tr>
                                        <td> Fecha de Inicio <input type="text" id="fechainicioreportesemanalFab" class="form-control"></td>
                                        <td> Fecha de Fin <input type="text" id="fechafinreportesemanalFab" class="form-control"></td>
                                        <td><button id="consultareportesemanalFab" class="btn btn-info consultareportesemanalFab">Consultar <span class="glyphicon glyphicon-search"></span></button></td>
                                    </tr>
                                </table>
                                ...
                                <table class="table table-striped table-bordered">                       
                                    <thead>
                                        <tr>
                                            ...
                                            <th>Categoria Vendedor</th>                             
                                            <th>Ganancias</th> 
                                        </tr>
                                    </thead>
                                    <tbody id="tablasemanalFab">
